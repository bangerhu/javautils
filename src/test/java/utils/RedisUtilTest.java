...
import com.hujiya.redis.JedisUtil;
...
public class RedisUtilTest extends TestCase {
    ...
    public void testConcurrency() throws Exception {
        ...
        assertEquals("" + num, JedisUtil.get(keyR));
    }
    ...
    private synchronized static void incr(String key) throws Exception {
        JedisUtil.set(key, String.valueOf(Integer.valueOf(JedisUtil.get(key)) + 1));
    }
}
